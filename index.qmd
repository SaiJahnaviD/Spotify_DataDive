---
title: "R_DataDive : Spotify_Tracks_Analysis"
---

In the project of analyzing Spotify Music Tracks, I performed an in-depth analysis of music track data to uncover trends and patterns related to track popularity, audio features, artist collaborations, and release timelines. Using R for data manipulation and visualization, I explored the distribution of track popularity across different genres and release years, investigated relationships between key audio features such as valence, energy, and danceability, and identified patterns in collaborative works among artists. 

Aggregation techniques and summary statistics were applied to formulate and answer novel research questions, providing insights into how musical characteristics relate to audience engagement. I also handled data preprocessing tasks, including managing missing values and creating meaningful groupings for categorical variables to enhance the clarity of the analysis.

Throughout the project, I focused on clear storytelling, combining statistical evidence with visual summaries to make the insights accessible to a broader audience. This analysis not only strengthened my skills in R programming, data visualization, and statistical interpretation but also demonstrated the practical application of exploratory data analysis (EDA) techniques to real-world music data.

The project demonstrates data analysis skills and reflects my ability to derive actionable insights from complex datasets and present them in a user-friendly and impactful way.
...
-   Majority of tracks have moderate popularity scores; very few tracks achieve extremely high popularity.

-   Tracks with higher energy and danceability scores tend to have higher popularity on average.

-   Positive correlations observed between valence (positiveness) and popularity for certain genres.

-   Recent years show a significant increase in the number of popular tracks, indicating growing platform reach and changes in listener behavior.

-   Certain genres like Pop and Hip-Hop dominate popularity charts, while niche genres maintain stable but lower popularity levels.

-   Collaborative tracks (featuring multiple artists) tend to have slightly higher popularity scores compared to solo tracks.

-   Energy and danceability features show a strong positive relationship across tracks, suggesting that energetic tracks are also more danceable.

-   Valence (happiness) varies widely across popular tracks, indicating that both happy and melancholic songs can achieve high popularity.
